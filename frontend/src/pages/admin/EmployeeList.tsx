...
export default function EmployeeList() {
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-16 text-left">
      ...
      <div className="p-4 bg-[#FFFDF9] rounded-2xl shadow-[0_1px_3px_rgba(45, 48, 48, 0.04)] border border-[#E2DDD5]">
        <div className="relative">
          ...
          <Input 
            ...
            className="pl-10 h-10 rounded-xl border-[#E2DDD5] focus:border-[#A85D4C] focus:ring-[#A85D4C]/20 bg-[#FFFDF9] text-sm text-[#292B2B]" 
            value={search} 
            ...
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-[#E2DDD5] font-medium text-[#292B2B]">
                {filtered.map(officer => (
                  <tr key={officer.id} className="hover:bg-[#EFEBE4]/50 transition-colors">
                    <td className="px-6 py-4 font-bold text-[#A85D4C]">{officer.name}</td>
                    <td className="px-6 py-4 text-[#292B2B]">{officer.role}</td>
                    <td className="px-6 py-4 text-[#7A756E]">{officer.dept}</td>
                    <td className="px-6 py-4">
                      <span className="font-bold text-sm text-[#292B2B] font-mono">{officer.score}%</span>
                    </td>
                    <td className="px-6 py-4">
                      <span className="text-[#B38A3D] font-bold font-mono">{officer.gaps} bottlenecks</span>
                    </td>
                    <td className="px-6 py-4">
                      {officer.score >= 80 ? (
                        ...
                        <span className="px-2.5 py-0.5 rounded-full text-xs font-mono font-semibold bg-[#B38A3D]/15 text-[#292B2B] border border-[#B38A3D]/35">
                          Priority Bottleneck
                        </span>
                      ) : (
                        <span className="px-2.5 py-0.5 rounded-full text-xs font-mono font-semibold bg-[#A85D4C]/10 text-[#A85D4C] border border-[#A85D4C]/20">
                          Active Learning
                        </span>
                      )}
                    </td>
                    <td className="px-6 py-4 text-right">
                      <Link to="/dashboard">
                        <Button size="sm" variant="ghost" className="text-[#A85D4C] hover:bg-[#A85D4C]/10 font-semibold cursor-pointer h-8 rounded-lg">
