...
export default function Competencies() {
    ...
    return (
      <div className="min-h-[400px] flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs font-semibold text-[#2D3030]">Loading workforce competency diagnostic matrix...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-16 text-left">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-[#292B2B]/10 pb-5">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-[#2D3030] tracking-tight">
