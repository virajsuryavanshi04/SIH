...
export default function HeroIntelligence({ onExploreClick, onHowItWorksClick }: Props) {
  ...
  return (
    <section className="relative pt-12 pb-20 lg:pt-16 lg:pb-28 px-4 sm:px-6 lg:px-8 border-b border-[#2B2D42]/10 overflow-hidden bg-[#F4F6F9]">
      ...
      <div className="absolute top-12 right-8 text-[10px] font-mono text-[#2B2D42]/30 uppercase tracking-widest pointer-events-none hidden lg:block">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
        ...
        <div className="lg:col-span-6 space-y-6 text-left">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-[#1F7A8C]/10 border border-[#1F7A8C]/20 text-[#1F7A8C]">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#0B2545] tracking-tight leading-[1.08]">
              Know the Gap. <br />
              <span className="text-[#1F7A8C]">Build the Capability.</span>
            </h1>
            <p className="text-base sm:text-lg text-[#2B2D42] leading-relaxed max-w-xl font-normal">
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5">
            <Button
              ...
              className="bg-[#1F7A8C] hover:bg-[#1F7A8C]/90 text-[#FFFFFF] font-bold px-7 h-12 shadow-sm text-sm cursor-pointer flex items-center justify-center gap-2"
            >
            ...
            <Button
              ...
              className="border-[#2B2D42]/20 text-[#0B2545] hover:bg-[#FFFFFF] hover:border-[#1F7A8C] hover:text-[#1F7A8C] font-semibold px-6 h-12 text-sm bg-transparent cursor-pointer"
            >
              See How It Works
            </Button>
          </div>
          ...
          <div className="pt-4 border-t border-[#2B2D42]/10 flex flex-wrap items-center gap-6 text-xs text-[#2B2D42]/70 font-mono">
        ...
        <div className="lg:col-span-6">
          <div className="relative bg-[#FFFFFF] rounded-2xl border border-[#2B2D42]/10 p-6 sm:p-8 shadow-sm overflow-hidden min-h-[460px] flex flex-col justify-between">
            {/* Top Bar telemetry */}
            <div className="flex items-center justify-between border-b border-[#2B2D42]/10 pb-3 text-xs font-mono">
              ...
              <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[#D4AF37]/15 text-[#0B2545] border border-[#D4AF37]/30">
                  ...
                  >
                    <div className={cn(
                      ...
                      <div className="text-left">
                        <div className="text-[11px] font-bold text-[#0B2545] leading-tight flex items-center gap-1">
                          <span>{node.label}</span>
                          {isGap && <AlertTriangle className="w-3 h-3 text-[#D4AF37]" />}
                        </div>
                        <div className="text-[9px] text-[#2B2D42]/60 font-mono">
                    ...
                    {isGap && (
                      <div className="absolute -bottom-5 left-1/2 -translate-x-1/2 whitespace-nowrap px-2 py-0.2 rounded-full bg-[#D4AF37] text-[#0B2545] text-[9px] font-bold shadow-xs">
                        PRIORITY BOTTLENECK
                      </div>
                    )}
                  </div>
            ...
            <div className="p-3 rounded-xl bg-[#F4F6F9] border border-[#2B2D42]/10 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs">
              <div className="flex items-center space-x-2 text-[#2B2D42]">
              ...
              <Link to="/login" className="shrink-0 text-[#1F7A8C] font-bold flex items-center hover:underline">
