...
export default function HeroIntelligence({ onExploreClick, onHowItWorksClick }: Props) {
  ...
  return (
    <section className="relative py-10 sm:py-14 lg:py-16 px-4 sm:px-6 lg:px-8 border-b border-[#D8E5EC] overflow-hidden bg-[#F4F8FB]">
      {/* Subtle background surface styling */}
      <div className="absolute inset-0 bg-[radial-gradient(#176B8708_1px,transparent_1px)] bg-[size:28px_28px] pointer-events-none" />
      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-6 space-y-4.5 text-left">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-[#176B87]/8 border border-[#176B87]/20 text-[#176B87]">
          ...
          <div className="space-y-3">
            <h1 className="text-4xl sm:text-5xl lg:text-[50px] font-extrabold text-[#123047] tracking-tight leading-[1.14]">
              Know the Gap. <br />
              <span className="text-[#176B87]">Build the Capability.</span>
            </h1>
            <p className="text-base sm:text-lg lg:text-[17px] text-[#5D7180] leading-[1.6] max-w-xl font-normal">
          ...
          <div className="pt-1 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <Link to="/login">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-[#176B87] hover:bg-[#176B87]/90 text-[#FFFFFF] text-[15px] font-semibold px-7 h-11.5 rounded-xl shadow-xs cursor-pointer flex items-center justify-center gap-2"
              >
            ...
            <Button
              ...
              className="w-full sm:w-auto border-[#D8E5EC] text-[#123047] hover:bg-[#FFFFFF] hover:border-[#176B87] hover:text-[#176B87] text-[15px] font-semibold px-6 h-11.5 rounded-xl bg-transparent cursor-pointer"
            >
              See How It Works
            </Button>
          </div>
          ...
          <div className="pt-3 border-t border-[#D8E5EC] flex flex-wrap items-center gap-6 text-xs text-[#5D7180] font-medium">
        ...
        <div className="lg:col-span-6">
          <div className="relative bg-[#FFFFFF] rounded-2xl border border-[#D8E5EC] p-4 sm:p-7 shadow-xs overflow-hidden min-h-[440px] sm:min-h-[450px] flex flex-col justify-between">
            {/* Top Bar Header */}
            <div className="flex items-center justify-between border-b border-[#D8E5EC] pb-3 text-xs">
              ...
              <span className="text-[10px] sm:text-[11px] font-semibold px-2 sm:px-2.5 py-0.5 rounded-full bg-[#D49A2A]/15 text-[#123047] border border-[#D49A2A]/30 font-mono shrink-0">
                ...
                return (
                  ...
                  >
                    <div className={cn(
                      ...
                      isGap 
                        ? "bg-[#FFFFFF] border-[#D49A2A] ring-1 ring-[#D49A2A]/25"
                        : node.status === 'proficient'
                        ? "bg-[#FFFFFF] border-[#2E8B57]/30 hover:border-[#2E8B57]"
                        : "bg-[#FFFFFF] border-[#D8E5EC] hover:border-[#176B87]"
                    )}>
                      {/* Radial Metric Pill */}
                      <div className={cn(
                      ...
                      <div className="text-left">
                        <div className="text-[11px] sm:text-xs font-bold text-[#123047] leading-tight flex items-center gap-1">
                          <span>{node.label}</span>
                          {isGap && <AlertTriangle className="w-3 h-3 text-[#D49A2A] shrink-0" />}
                        </div>
                        <div className="text-[9px] sm:text-[10px] text-[#5D7180] font-mono">
                    ...
                    {isGap && (
                      <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 whitespace-nowrap px-1.5 sm:px-2 py-0.5 rounded-md bg-[#D49A2A] text-[#123047] text-[8px] sm:text-[9px] font-bold shadow-xs">
                        PRIORITY BOTTLENECK
                      </div>
                    )}
                  </div>
            ...
            <div className="p-3 sm:p-3.5 rounded-xl bg-[#EAF3F7] border border-[#D8E5EC] flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs">
              ...
              <Link to="/login" className="shrink-0 text-[#176B87] font-semibold flex items-center hover:underline text-[11px] sm:text-xs">
