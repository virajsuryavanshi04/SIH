  ...
  return (
    <div className="space-y-6">
      ...
      <div
        ...
        className="cursor-pointer select-none min-h-[260px] bg-white border-2 border-slate-200 hover:border-emerald-400 rounded-2xl p-8 shadow-sm flex flex-col justify-between transition-all duration-200"
      >
        <div className="flex items-center justify-between text-xs font-semibold uppercase tracking-wider">
          <span className={`px-2.5 py-1 rounded-md ${isFlipped ? 'bg-emerald-100 text-emerald-800' : 'bg-slate-100 text-slate-600'}`}>
            {isFlipped ? 'Answer / Explanation' : 'Question / Prompt'}
          </span>
          <span className="text-slate-400 flex items-center gap-1 font-normal lowercase">
            <RotateCw className="w-3.5 h-3.5" /> click to flip (Space)
          </span>
        </div>
      ...
      <div className="flex items-center justify-between pt-2">
        <button
          ...
          className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-white border border-slate-200 hover:bg-slate-50 disabled:opacity-40 disabled:hover:bg-white text-slate-700 font-medium rounded-xl text-sm transition shadow-xs"
        >
        ...
        <button
          onClick={() => setIsFlipped(!isFlipped)}
          className="px-5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-800 font-medium rounded-xl text-sm transition flex items-center gap-2"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-40 disabled:hover:bg-emerald-600 text-white font-medium rounded-xl text-sm transition shadow-xs"
        >
